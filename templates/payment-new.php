...
get_header( 'payment-new' );
?>
	<main class="why-sitch-top-outer">
		<section id="why-sitch-top" class="why-sitch">
			...
			<p>
				<a href="#">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/watch-now.webp" class="img-fluid" alt="Watch now" />
				</a>
			</p>
		</section>
	</main>

	<main class="group-chat-outer">
		<section id="group-chat" class="group-chat">
			<div class="group-chat-heading">
				<h2>
					We send you <em>curated</em><br />
					candidates that keep improving
				</h2>
			</div>

			<div class="group-chat-img">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/group-chat-1.webp" class="img-fluid" alt="Sitch group chat" />
			</div>
			<div class="group-chat-heading">
				<h2>
					We <em>introduce</em> you<br />
					via group chat if you both say yes.
				</h2>
			</div>
			<div class="group-chat-img">
	...
	<main>
		<section id="faqs" class="faqs faqs-new">
			<h1 class="text-center">
				<em>Questions we know you have</em>
			</h1>
			...
			<div id="faqs-accordion" class="accordion">
				<div class="accordion-item">
					...
					<div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#faqs-accordion">
